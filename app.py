...
q1 = "Question 1: What animal has a long neck?"
a1 = "Giraffe"
q2 = "Question 2: What animal is man's best friend?"
a2 = "Dog"
q3 = "Question 3: What animal makes the noise 'meow'"
a3 = "Cat"
q4 = "Question 4: What animal has one horn"
a4 = "Rhino"
q5 = "Question 5: What is Rice's mascot?"
a5 = "Owl"
...
def run_program(recipient_id, message):
    ...
    if state == "None":
        if message == "hello"
            send_message(recipient_id, "Welcome to Quizlett-Bot. Send 'quiz' to get started)
